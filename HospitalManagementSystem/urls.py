...
urlpatterns = [
    ...
    # path('superAdmin/', include('admin_adminlte.urls')),
    ...
    path('heartdisease/',heart_disease_prediction,name='heartdisease'),
    path('diabetesdisease/',diabetes_disease_prediction,name='diabetesdisease'),
